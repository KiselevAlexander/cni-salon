...
$APPLICATION->SetTitle("CNI-salon Краснодар - первая специализированная ногтевая студия");
/**
...
<section class="mbr-slider mbr-section mbr-section__container carousel slide mbr-section-nopadding mbr-after-navbar" data-ride="carousel" data-keyboard="false" data-wrap="true" data-pause="false" data-interval="5000" id="slider3-1" data-rv-view="81">
    <div>
        <div>
            <div>
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="mbr-section mbr-section-hero carousel-item dark center mbr-section-full active" data-bg-video-slide="false" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/assets/images/a2oss-cagai-2000x2000.jpg);">
                    ...
                    </div><div class="mbr-section mbr-section-hero carousel-item dark center mbr-section-full" data-bg-video-slide="false" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/assets/images/1e1b410633a1ffe3c1530e0781652d969dd8184b1c7aae2323pimgpsh-fullsize-distr-2000x2000.jpg);">
                        <div class="mbr-table-cell">
                            <div class="mbr-overlay"></div>
                            <div class="container-slide container">
                    ...
                    </div><div class="mbr-section mbr-section-hero carousel-item dark center mbr-section-full" data-bg-video-slide="false" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/assets/images/man-back.jpg);">
                        <div class="mbr-table-cell">
                            <div class="mbr-overlay"></div>
                            <div class="container-slide container">
...
<section class="mbr-section mbr-section__container" id="buttons1-d" data-rv-view="150" style="background-color: rgb(255, 255, 255); padding-top: 20px; padding-bottom: 20px;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="text-xs-center"><a class="btn btn-primary" href="#/mobirise-free-win.zip">больше фото</a> <a class="btn btn-black btn-black-outline" href="#/mobirise-free-mac.zip">записаться</a></div>
            </div>
        </div>
    </div>
